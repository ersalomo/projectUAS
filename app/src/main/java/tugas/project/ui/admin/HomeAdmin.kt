                ...
                if(snapshot.exists()) {
                    ...
                    adapterDog.setOnItemListener(object :AdapterDog.OnCLickedItem{
                        override fun onClickedItem(anjing: Anjing) {
                            Toast.makeText(this@HomeAdmin,"You cliked ${anjing.nama}",Toast.LENGTH_LONG).show()
                        }
...
//            val delMtk = FirebaseDatabase.getInstance().getReference("tmtk").child(mahasiswa.id)
            delDog.removeValue()
//            delMtk.removeValue()
